...
import com.broken.center.BrokenCenter;
...
public class UpdateChecker extends AsyncTask<Context, Integer, String> {
    ...
    private String strDevice, brokenCurVer;
    ...
    protected String doInBackground(Context... arg) {
        mContext = arg[0];
        Message msg;
        if (mContext != null && mContext.toString().contains("BrokenCenter")) {
        ...
        try {
            ...
            if (mNoLog == false) Log.d(TAG, "strDevice="+strDevice+ "   brokenCurVer="+brokenCurVer);
            if (strDevice == null || brokenCurVer == null) return null;
             ...
             if(eventType == XmlPullParser.START_DOCUMENT) {
                 ...
                 if (tagMatchesDevice && inFileName) {
                    ...
                    try {
                        ...
                        if (versionOnServer.compareToIgnoreCase(brokenCurVer)>0) newFileName = tempFileName;
    ...
    private void showNotification() {
        Notification.Builder mBuilder = new Notification.Builder(mContext)
            ...
            .setSmallIcon(R.drawable.ic_notification_brokenota)
            .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_brokenota));

        Intent intent = new Intent(mContext, BrokenCenter.class);
